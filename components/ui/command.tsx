...
function CommandDialog({
  ...
  description = "Buscar comandos y navegar.",
  children,
  className,
  ...
  return (
    <Dialog {...props}>
      ...
      >
        ...
        <Command
          className={cn(
            "**:[[cmdk-group-heading]]:text-muted-foreground **:[[cmdk-group-heading]]:px-3 **:[[cmdk-group-heading]]:pt-2 **:[[cmdk-group-heading]]:pb-1 **:[[cmdk-group-heading]]:text-[11px] **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:uppercase **:[[cmdk-group-heading]]:tracking-wider",
            "**:[[cmdk-group]]:px-1 **:[[cmdk-input]]:h-12",
